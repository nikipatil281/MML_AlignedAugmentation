# scripts/eval_retrieval_token_models.py
...
def build_single_caption_subset(dataset: CocoRetrievalDataset) -> CocoRetrievalDataset:
    # reuse same dataset object, but only keep caption index 0 per image
    subset = dataset
...
def main():
    ...
    test_dataset = build_single_caption_subset(splits.test)
    ...
    # 🔁 choose which checkpoint you want to evaluate:
    ckpt_path = "checkpoints/retrieval_tokenmix_align_model.pt"
    # or: "checkpoints/retrieval_tokenmix_model.pt"
